...
const categories: Record<string, Category> = {
  ...
  quark: {
    name: 'Quark',
    wp: 'Quark',
    desc: 'Elementary particles, combine to form hadrons.',
    color: '#f8f',
  },
  lepton: {
    name: 'Lepton',
    wp: 'Lepton',
    desc: 'Elementary particle with half-integer spin.',
    color: '#8f8',
  },
  gaugeboson: {
    name: 'Gauge Boson',
    wp: 'Gauge_boson',
    desc: 'A force carrier.',
    color: '#f88',
  },
  scalarboson: {
    name: 'Spin 0 Boson',
    wp: 'Scalar_boson',
    desc: 'Similar to a gauge boson, but with spin 0.',
    color: '#ff8',
  },
  ...
  pt_unknown: {
    name: 'Unknown',
    wp: 'Periodic_table#Elements_with_unknown_chemical_properties',
